...
config_store.store(name='bert_tiny', node=BertTinyEncoderConfig, group='encoder')
config_store.store(name='bert_mini', node=BertMiniEncoderConfig, group='encoder')
config_store.store(name='bert_small', node=BertSmallEncoderConfig, group='encoder')
config_store.store(name='bert_medium', node=BertMediumEncoderConfig, group='encoder')
